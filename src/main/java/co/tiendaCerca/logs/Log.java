package co.tiendaCerca.logs;

import co.tiendaCerca.utils.GeneralUtilities;
...
public class Log {
    ...
    public static void writeOperationExeption(String exeption){
        String msjLogger ="Operation failed: ".concat(exeption);
        Log.LOGGER.info(msjLogger);
        Assert.fail();
    }
